...
extension UIViewController {
  ...
  func presentSortOptions(handler: ((UIAlertAction) -> Void)?){
    ...
    sortController.addAction(UIAlertAction(title: "Name", style: .default, handler: handler))
    sortController.addAction(UIAlertAction(title: "Date", style: .default, handler: handler))
    sortController.addAction(UIAlertAction(title: "Added", style: .default, handler: handler))
