...
protocol CategoryViewCoordinatorType {
  func start(dataSource: [Category], selectedIndex: Property<Int?>) -> CategoryViewController
}
...
class CategoryViewCoordinator: CategoryViewCoordinatorType {
  ...
  func start(dataSource: [Category], selectedIndex: Property<Int?>) -> CategoryViewController {
    let viewModel = CategoryViewModel(coordinator: self, selectedIndex: selectedIndex, categories: dataSource)
